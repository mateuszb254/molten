    ...
    private function getArticles(): array
    {
        return [
            [
                ...
                'author' => $this->getReference(AccountFixtures::GLOBAL_ADMIN_REFERENCE_NAME),
            ...
            [
                ...
                'createdAt' => (new \DateTime())->modify('-4 DAY'),
                'author' => $this->getReference(AccountFixtures::ADMIN_USER_REFERENCE_NAME),
                'more' => null
            ],
            [
                ...
                'author' => $this->getReference(AccountFixtures::MODERATOR_REFERENCE_NAME),
                'more' => null
            ],
            [
